...
export const CommentBox = ({ onSubmit, currentUser, placeholder = "Type / for menu" }) => {
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative">
              <textarea
                ...
                className="w-full min-h-[80px] p-3 text-gray-700 placeholder-gray-400 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
              />
