...
export default function ReportsPage() {
  ...
  const [reportType, setReportType] = useState('tasks'); // 'tasks', 'departments', 'manual-time'
              ...
              <div className="bg-[#2a2a2e] border border-gray-700/50 rounded-xl p-16 text-center shadow-lg">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-gray-400 mb-6 leading-relaxed">
                    Configure your filters and click the "Generate Report" button to view detailed insights for {headingTitle.toLowerCase()}.
                  </p>
